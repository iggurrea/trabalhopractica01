...
class _BaseCalcState extends State<BaseCalc> {
  ...
  void _convert() {
    try {
      ...
      //If we have an error, we need to show the error message
      setState(() {
          ...
          children: [
            ...
            DropdownButton<String>(
              ...
              onChanged: (val) => setState(() =>
                  _fromBase = val!), // Updates state when new value is selected
              items: bases
            ...
            TextField(
              controller:
                  _input, // Controller to read and manage the input text
              decoration: const InputDecoration(
                  labelText: 'input number'), // Placeholder/label
            ...
            DropdownButton<String>(
              ...
              onChanged: (val) =>
                  setState(() => _toBase = val!), // Updates state on selection
              items: bases
                  .map((b) => DropdownMenuItem(
                        value: b,
